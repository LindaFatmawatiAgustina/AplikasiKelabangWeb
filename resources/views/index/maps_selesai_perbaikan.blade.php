  ...
  <div class="row content">
    <div class="col-md-12 col-xs-12 map">
      ...
      <script type="text/javascript">
        ...
        array.push(['<?php echo $tempatsampahs->nama ?>', '<?php echo $tempatsampahs->latitude ?>', '<?php echo $tempatsampahs->longitude ?>', '<?php echo $tempatsampahs->status ?>', '<?php echo $tempatsampahs->file_gambar ?>', '<?php echo $tempatsampahs->file_gambar2 ?>', '<?php echo $tempatsampahs->file_gambar3 ?>']);
      </script>
